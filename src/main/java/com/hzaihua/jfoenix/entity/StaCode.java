...
public class StaCode extends RecursiveTreeObject<StaCode> {
    ...
    private SimpleIntegerProperty detail;
    ...
    public SimpleIntegerProperty detailProperty() {
        return detail;
    }

    public void setDetail(int detail) {
        this.detail = new SimpleIntegerProperty(detail);
    }

    public StaCode(String noiseCode, Date measureTime, double leqT, double LAFmax, double LAF5, double LAF10, double LAF50, double LAF90, double LAF95, double SD, double LAFmin, String normal, double rate, String sift, double softRate, int detail) {
        this.noiseCode = new SimpleStringProperty(noiseCode);
        this.measureTime = measureTime;
        this.leqT = new SimpleDoubleProperty(leqT);
        this.LAFmax = new SimpleDoubleProperty(LAFmax);
