...
public class HourStaCode extends RecursiveTreeObject<HourStaCode> {
    ...
    public HourStaCode(String noiseCode, Date measureTime, double leqT, double LAFmax, double LAF5, double LAF10, double LAF50, double LAF90, double LAF95, double SD, double LAFmin, String normal, double rate, String sift, double softRate) {
        this.noiseCode = new SimpleStringProperty(noiseCode);
        this.measureTime = measureTime;
        this.leqT = new SimpleDoubleProperty(leqT);
        this.LAFmax = new SimpleDoubleProperty(LAFmax);
