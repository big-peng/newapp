...
public class WeatherHour extends RecursiveTreeObject<WeatherHour> {
    ...
    public WeatherHour(String noiseCode, Date measureTime, int unitTime, double w_Speed, double w_Direction, double a_Temp, double humi_R, double ari_p, double PRF, double maxSpeed, double minSpeed, double maxHumi, double minHumi, double maxAtemp, double minAtemp) {
        this.noiseCode = new SimpleStringProperty(noiseCode);
        this.measureTime = measureTime;
        this.unitTime = new SimpleIntegerProperty(unitTime);
        this.w_Speed = new SimpleDoubleProperty(w_Speed);
