...
public class CarFlowDate extends RecursiveTreeObject<CarFlowDate> {
    ...
    public CarFlowDate(String noiseCode, Date measureTime, String radarID, int unitTime, int roadWayNum, double totalFlux, double occupyRation, double longRation, double midRation, double shortRation, double avgSpeed, double longSpeed, double midSpeed, double shortSpeed, double preFlux, double longCarNums, double midCarNums, double shortCarNums) {
        this.noiseCode = new SimpleStringProperty(noiseCode);
        this.measureTime = measureTime;
        this.radarID = new SimpleStringProperty(radarID);
        this.unitTime = new SimpleIntegerProperty(unitTime);
