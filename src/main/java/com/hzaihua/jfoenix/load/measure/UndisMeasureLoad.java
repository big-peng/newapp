...
import com.hzaihua.jfoenix.controller.measure.UndisMeasureController;
...
public class UndisMeasureLoad extends Application{
    public UndisMeasureLoad(){
        super();
        try{
            start(new Stage());
        }catch (Exception e){
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Flow flow = new Flow(UndisMeasureController.class);
