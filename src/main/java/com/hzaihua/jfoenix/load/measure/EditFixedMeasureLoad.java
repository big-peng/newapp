...
public class EditFixedMeasureLoad extends Application {
    public EditFixedMeasureLoad(){
        super();
        try {
            start(new Stage());
        }catch (Exception e){
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Flow flow = new Flow(EditFixedMeasureController.class);
